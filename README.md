...
[![My Skills](https://skillicons.dev/icons?i=bash,c,cpp,cmake,css,docker,ros,express,firebase,git,github,html,js,linux,mongodb,mysql,netlify,opencv,nodejs,pug,py)](https://skillicons.dev)
