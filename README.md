...
<p align="left"> <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=androidstudio,arduino,aws,bash,c,cpp,cmake,cs,css,html,js,java,react,redux,angular,dotnet,docker,tensorflow,nodejs,pug,py,tailwind,ros,express,firebase,git,github,linux,powershell,postman,mongodb,mysql,netlify,opencv" />
    </a> </p>
